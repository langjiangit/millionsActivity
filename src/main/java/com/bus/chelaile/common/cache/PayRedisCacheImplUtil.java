...
public class PayRedisCacheImplUtil implements ICache {
	private static Logger log = LoggerFactory.getLogger(PayRedisCacheImplUtil.class);

	protected static final Logger logger = LoggerFactory.getLogger(PayRedisCacheImplUtil.class);

	private static String DEFAULT_REDIS_HOST = PropertiesUtils.getValue(PropertiesName.CACHE.getValue(),
			"pay.redisCount.host", "121.41.23.113");
	private static int DEFAULT_REDIS_PORT = Integer.parseInt(PropertiesUtils.getValue(PropertiesName.CACHE.getValue(),
			"pay.redisCount.port", "6379"));
	private static String DEFAULT_REDIS_PASSWARD = PropertiesUtils.getValue(PropertiesName.CACHE.getValue(),
			"pay.redisCount.password", "gr8Q39DO3pIszMJU");;
	private static int DEFAULT_REDIS_DATABASE = Integer.parseInt(PropertiesUtils.getValue(PropertiesName.CACHE.getValue(),
			"pay.redisCount.DB", "7"));
	...
	private static void initPool() {
		...
		String password = DEFAULT_REDIS_PASSWARD;
		int database = DEFAULT_REDIS_DATABASE;
