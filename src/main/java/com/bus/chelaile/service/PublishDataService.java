...
public class PublishDataService {
	...
	public String sendResult(QuestionParam param) {
		...
		logger.info("活动结束：{}，发送结果，真实过关用户数为：{}, livePeopleKey={}", activity.getActivityId(), allAnswers.size(),
				livePeopleKey);
	...
	public static void main(String[] args) {
		...
		// CacheUtil.pushMoney("drawMoneyQueue",
		// JSONObject.toJSONString(moneyModel));
